...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='DiscountCoin.conf'
CONFIGFOLDER='/root/.DiscountCoin'
COIN_DAEMON='/usr/local/bin/DiscountCoind'
COIN_CLI='/usr/local/bin/DiscountCoind'
COIN_REPO='https://github.com/DiscountCoin/dsc/releases/download/9b1aa54/DiscountCoind'
COIN_NAME='Discount'
COIN_PORT=9448
RPC_PORT=9447
